...
const ProductScreen: FunctionComponent = () => {
    ...
    const productDetails = useSelector((state: ReduxState) => state.productDetails)
    const { loading, product, error } = productDetails

    const productReviewCreate = useSelector(
        (state: ReduxState) => state.createProductReview as ProductCreateReviewState
    )
    ...
    useEffect(() => {
        ...
        if (id) {
            dispatch(detailProduct(id as string))
        }
                    ...
                    <Row>
                        ...
                        <Col md={3}>
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>Genres: ${product.genres}</ListGroup.Item>
                                <ListGroup.Item>Character: ${product.character}</ListGroup.Item>
                                <ListGroup.Item>Size: ${product.size}</ListGroup.Item>
                                <ListGroup.Item>Series: ${product.series}</ListGroup.Item>
